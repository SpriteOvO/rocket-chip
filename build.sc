...
import $file.`chisel-circt-binder`.dependencies.chisel3.build
import $file.`chisel-circt-binder`.dependencies.firrtl.build
import $file.`chisel-circt-binder`.dependencies.treadle.build
import $file.`chisel-circt-binder`.dependencies.chiseltest.build
import $file.`chisel-circt-binder`.{common => binder_common}

import $file.`chisel-circt-binder`.build

object v {
  val scala = "2.13.10"
}

object myfirrtl extends `chisel-circt-binder`.dependencies.firrtl.build.firrtlCrossModule(v.scala) {
  override def millSourcePath = os.pwd / "chisel-circt-binder" / "dependencies" / "firrtl"
...
object mytreadle extends `chisel-circt-binder`.dependencies.treadle.build.treadleCrossModule(v.scala) {
  override def millSourcePath = os.pwd / "chisel-circt-binder" / "dependencies" / "treadle"

  def firrtlModule: Option[PublishModule] = Some(myfirrtl)
}

object mychisel3 extends `chisel-circt-binder`.dependencies.chisel3.build.chisel3CrossModule(v.scala) {
  override def millSourcePath = os.pwd / "chisel-circt-binder" / "dependencies" / "chisel3"
...
object mychiseltest extends `chisel-circt-binder`.dependencies.chiseltest.build.chiseltestCrossModule(v.scala) {
  override def millSourcePath = os.pwd / "chisel-circt-binder" / "dependencies" / "chiseltest"
...
object circt extends Module {
  def circtSourcePath = os.pwd / "chisel-circt-binder" / "dependencies" / "circt"

  def llvmSourcePath = os.pwd / "chisel-circt-binder" / "dependencies" / "llvm-project"
...
object `circt-jextract` extends binder_common.ChiselCIRCTBinderPublishModule
  with JavaModule {
...
object bench_circt extends `chisel-circt-binder`.common.ChiselCIRCTBinderModule
  with ScalaModule
  with ScalafmtModule {
  m =>
  def scalaVersion = T {
